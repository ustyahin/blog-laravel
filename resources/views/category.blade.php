    ...
    @foreach ($post as $posts)
        <div class='card'>
            <table border='1'>
                ...
                <tr>
                    <td align='center'>Категория: {{$posts->category_name}}</td>
                    <td align='center'>Автор: {{$posts->user}}</td>
                </tr>
                <tr>
                    <td align='center'>Дата: {{$posts->date}}</td>
                    <td align='center'>Изменено: {{$posts->date_changed}}</td>
                </tr>


                <tr>
                    <td align='center'><a href="/post/{{$posts->id}}/delete">Удалить</a></td>
                    <td align='center'><a href="/post/{{$posts->id}}/edit">Изменить</a></td>
                </tr>
